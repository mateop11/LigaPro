...
namespace LigaPro.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public EquipoesController(LigaProContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["EstadioId"] = new SelectList(_context.Estadios, "Id", "Ciudad");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Ciudad,Titulos,AceptaExtranjeros,EstadioId")] Equipo equipo)
        {
            ...
            ViewData["EstadioId"] = new SelectList(_context.Estadios, "Id", "Ciudad", equipo.EstadioId);
            return View(equipo);
        }
